### **Sesión 03: Interacción con el Sistema Operativo y Redes**
#### **Objetivos:**
- Aprender a interactuar con el sistema operativo utilizando Python. Dominar el uso de módulos como `os` y `subprocess`.      Aprender a manejar operaciones de red básicas utilizando módulos como `socket` y `requests`.
...
### **Interacción con el Sistema Operativo y Redes - Detalles adicionales**
